 ...
 * Exporte la base locale sans les vues (compatibles InfinityFree)
 */
...
try {
    ...
    echo "<h2>📤 Export de la base de données ASOD ACADEMIE</h2>";
    ...
    $sqlFile = 'asod_academie_export_' . date('Y-m-d_H-i-s') . '.sql';
    ...
    fwrite($file, "-- Export de la base de données ASOD ACADEMIE\n");
    fwrite($file, "-- Date: " . date('Y-m-d H:i:s') . "\n");
    fwrite($file, "-- Compatible InfinityFree (sans vues)\n\n");
